            ...
            try:
                ...
                if row.isdigit() and column.isdigit():
                    ...
                    if int(row) in [0, 1, 2] and int(column) in [0, 1, 2]:
                        ...
                        # Print "Wrong coordinates!" error message
                        print("│ Wrong coordinates!")
                else:
                    # Print "You should enter numbers!" error message
...
class Grid(object):
    ...
    def set_field(self, move):
        ...
        if self.get_field(move.row, move.column) != "■":
            # Print "This field is taken!" error message
...
class Game(object):
    ...
    def game_over(self):
        # For each row
        for row in range(3):
            # Check if signs in row are the same
        ...
        for column in range(3):
            # Check if signs in columns are the same
            if self.grid.get_field(0, column) == \
                ...
                # Return True
                return True
        # Check if signs on diagonal from left top are the same
        if self.grid.get_field(0, 0) == \
            ...
            # Return True
            return True
        # Check if signs on diagonal from left bottom are the same
        if self.grid.get_field(2, 0) == \
            ...
            # Return True
            return True
        # Check if next move is not possible
